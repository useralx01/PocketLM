...
- Next DeepSeek runtime step: carry KV cache through FP8 MLA attention and connect token embedding/final norm/lm_head so the single-block proof becomes a real token decode path.
