...
- Next DeepSeek status step: surface the same FP8 runtime-policy summary in the user-facing model/acquisition view after the runtime path becomes fast enough for normal use.
