...
- Make speculative decoding stateful: verifier KV must prefill once, verify candidate chunks as continuations, and commit/rollback KV instead of rerunning the full prompt stack per speculative pass.
