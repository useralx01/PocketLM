...
- Next DeepSeek speed step: replace materialized Python FP8 expert dequant with a fused/paged matmul path so selected experts do not become BF16 resident tensors.
