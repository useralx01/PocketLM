...
PLM-14 awaiting operator: cloud GPU smoke pipeline, Colab/Kaggle notebook, docs, and tests landed; local CPU smoke passes and full suite is `468 passed, 1 skipped`, but this checkout has no GitHub remote, so push and real free-GPU notebook evidence require operator repo/token setup.
