...
PLM-13 GPU attempt 2: real DeepSeek V3 remote-range CUDA layer validator is implemented, notebook points at it, and local full suite passes (`477 passed, 2 skipped`); awaiting the next browser GPU JSON.
