...
Phase Q4 MoE Fused Expert Load update: guarded front-layer Q4 attention cache is now default for Q4 MoE and keeps correctness intact; clean rerun is coherent at `9.0416s` second token, with one better-RAM probe at `7.9918s`, but stable under-8 is not proven yet.
