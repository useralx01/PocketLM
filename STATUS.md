...
Phase BF16 MoE Load Reuse: low-RAM chunked BF16 MoE prefill keeps Mixtral full decode stable and improves one-token runtime from 307.91s to 268.187s with 390 tests passing, but BF16 MoE remains too slow for Kimi/DeepSeek until tensor bytes loaded/expert compute are cut harder.
