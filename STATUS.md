...
Phase Kimi DeepSeek Readiness: BF16 MoE layer-major chunked prefill improves Mixtral one-token runtime from 307.91s to 211.960s safe/default and 206.121s tuned, with 391 tests passing; local software is safer, but full BF16 Kimi/DeepSeek is still not download-ready on this 16 GB machine because tensor loading remains above 150s/token.
