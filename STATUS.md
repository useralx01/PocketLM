...
Phase BF16 MoE Proof: local Mixtral BF16 MoE now passes expert repeat, all-layer MoE, and one-token full decode after a BF16 MoE lm-head cache fix; full suite 388 passed, but full BF16 MoE is still far too slow/memory-heavy for Kimi/DeepSeek download next.
