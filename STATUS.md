...
Phase Huge MoE Compact Readiness: Q4 dry-run planning now estimates huge-MoE compact artifact size from safetensors headers without loading payloads; local Mixtral and Qwen3-30B-A3B planning rows are clean, and full suite passes with 394 tests.
