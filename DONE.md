...
PLM-15 auto-resume guard: done. Added the guarded PowerShell resume script, installed the every-2-hours Windows task, and added a Codex app cron backup for logged-out/autonomous continuity.
